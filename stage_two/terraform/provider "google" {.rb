provider "google" {
  credentials = file("/home/blake/Downloads/acquired-rite-440014-v4-67678ab52c09.json") # Replace with your service account key path
...
resource "google_compute_instance" "app_server" {
  ...
  # Provisioner to copy files to the APPS directory
  provisioner "file" {
    source      = "/home/blake/Desktop/yolo/*"      # Path to the files you want to copy
    destination = "/home/enochblake/APPS/"      # Copy files to the APPS directory
  }

  provisioner "file" {
    source      = "/home/blake/Desktop/yolo"      # Path to the folder you want to copy
    destination = "/home/enochblake/APPS/new_folder_name/"  # Create a new folder in APPS
  }
